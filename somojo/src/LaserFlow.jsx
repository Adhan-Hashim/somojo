...
export const LaserFlow = ({
    ...
    useEffect(() => {
        ...
        // Safety check if already contains canvas
        ...
        const setSizeNow = () => {
            ...
            if (!pausedRef.current && scene && camera) {
        ...
        // Removed IntersectionObserver to prevent the background from pausing
        // when covered by the preloader or other full-screen overlays.
        ...
        const onCtxLost = e => {
            e.preventDefault();
            console.warn('LaserFlow WebGL Context Lost!');
            pausedRef.current = true;
        };
        const onCtxRestored = () => {
            console.log('LaserFlow WebGL Context Restored!');
        ...
        return () => {
            ...
            // Force WebGL context to be released immediately to prevent max context limit (black screens)
